        ...
        <div className="w-full flex justify-between items-center gap-12">
          ...
          <div className="w-[636px] p-10 bg-indigo-50 rounded-lg border border-blue-400 flex flex-col justify-start items-start gap-10">
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              <div className="text-slate-950 text-3xl font-black font-sans leading-10">Send us a Message</div>
            </div>
            ...
            <div className="self-stretch flex justify-start items-center gap-6">
              <div className="flex-1 pt-2.5 pb-6 border-b-[0.5px] border-zinc-400">
                <div className="text-neutral-600 text-lg font-normal font-sans leading-7">Full Name</div>
              </div>
            </div>

            <div className="self-stretch flex justify-start items-center gap-6">
              <div className="flex-1 pt-2.5 pb-6 border-b-[0.5px] border-zinc-400">
                <div className="text-neutral-600 text-lg font-normal font-sans leading-7">Email</div>
              </div>
            </div>

            <div className="self-stretch pt-2.5 pb-16 border-b-[0.5px] border-zinc-400">
              <div className="text-neutral-600 text-lg font-normal font-sans leading-7">Message</div>
            </div>

            {/* Submit Button */}
            <Button className="h-12 px-4 bg-blue-600 hover:bg-blue-700 rounded-xl flex items-center gap-1">
              <span className="text-neutral-50 text-base font-medium font-sans leading-relaxed">Send Message</span>
      ...
      <div className="self-stretch flex flex-col sm:flex-row justify-start items-stretch gap-8">
        ...
        <div className="flex-1 min-w-0 p-10 bg-indigo-50 rounded-[20px] border border-blue-400 flex flex-col justify-start items-start gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-4">
            <div className="text-neutral-900 text-xl font-medium font-sans leading-loose">Email</div>
            <div className="text-neutral-600 text-lg font-normal font-sans leading-7">example@gmail.com</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0 p-10 bg-indigo-50 rounded-[20px] border border-blue-400 flex flex-col justify-start items-start gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-4">
            <div className="text-neutral-900 text-xl font-medium font-sans leading-loose">Phone</div>
            <div className="text-neutral-600 text-lg font-normal font-sans leading-7">+85 555 8888 6666</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0 p-10 bg-indigo-50 rounded-[20px] border border-blue-400 flex flex-col justify-start items-start gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-4">
            <div className="text-neutral-900 text-xl font-medium font-sans leading-loose">Location</div>
