    ...
    return (
        <div className='flex flex-col custom-Container gap-12 pb-25 pt-10'>
            ...
            <div className='flex flex-col  md:flex-row justify-between gap-8'>
                <div className='h-[939px] max-w-[720px] w-full items-start'>
                    {/* form */}
                    <ConsultationForm />
                </div>
                <div className='w-full max-w-[600px] flex flex-col gap-6 items-center'>
                    {/* callender */}
                    <div className=" lg:max-w-72 text-center  text-neutral-800 text-2xl font-semibold font-['Poppins'] leading-9">Let’s Talk – Pick a Time That Works for You</div>
                    <div className='flex flex-col p-10 w-full  gap-[33.85px] shadow-[0px_4px_25.899999618530273px_24px_rgba(109,109,109,0.03)] items-center'>
                        <div className="w-full text-zinc-900 text-3xl font-bold font-['Proxima_Nova'] leading-10">Select a Date & Time</div>
                        <DateRangePicker />
