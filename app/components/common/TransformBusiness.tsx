    ...
    return (
        <div className='flex flex-col custom-Container gap-8 sm:gap-10 md:gap-12 py-16 sm:py-20 md:py-24'>
            ...
            <div className='flex flex-col  md:flex-row justify-between gap-6 sm:gap-8'>
                <div className='h-auto md:h-[939px] max-w-[720px] w-full items-start'>
                    {/* form */}
                    <ConsultationForm />
                </div>
                <div className='w-full max-w-[600px] flex flex-col gap-4 sm:gap-6 items-center'>
                    {/* callender */}
                    <div className=" lg:max-w-72 text-center  text-neutral-800 text-xl sm:text-2xl font-semibold font-['Poppins'] leading-7 sm:leading-9">Let's Talk – Pick a Time That Works for You</div>
                    <div className='flex flex-col p-6 sm:p-8 md:p-10 w-full  gap-6 sm:gap-8 md:gap-[33.85px] shadow-[0px_4px_25.899999618530273px_24px_rgba(109,109,109,0.03)] items-center'>
                        <div className="w-full text-zinc-900 text-2xl sm:text-3xl font-bold font-['Proxima_Nova'] leading-8 sm:leading-10">Select a Date & Time</div>
                        <DateRangePicker />
                        <div className='w-full flex gap-4 sm:gap-[18.7px] items-center'>
                            <svg width="20" height="20" className="sm:w-[22px] sm:h-[22px]" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
