...
const TransformBusiness = () => {
    ...
    return (
        <div className='flex flex-col custom-Container gap-8 md:gap-10 lg:gap-12 py-16 md:py-20 lg:py-24'>
            <div className='flex flex-col lg:flex-row  justify-between items-start lg:items-end gap-6 md:gap-8'>
                ...
                <div className="w-full lg:max-w-96 lg:text-right text-neutral-600 text-sm sm:text-base md:text-lg font-normal font-['Inter'] leading-relaxed md:leading-loose">Get a free consultation and discover Wow we can optimize your operations</div>
            </div>
            <div className='flex flex-col lg:flex-row justify-between gap-6 md:gap-8'>
                <div className='h-auto lg:h-[939px] max-w-[720px] w-full items-start'>
                    {/* form */}
                    <ConsultationForm />
                </div>
                <div className='w-full max-w-[600px] flex flex-col gap-4 md:gap-6 items-center'>
                    {/* callender */}
                    <div className=" lg:max-w-72 text-center  text-neutral-800 text-lg sm:text-xl md:text-2xl font-semibold font-['Poppins'] leading-7 md:leading-9">Let's Talk – Pick a Time That Works for You</div>
                    <div className='flex flex-col p-6 sm:p-8 md:p-10 w-full  gap-6 sm:gap-8 md:gap-[33.85px] shadow-[0px_4px_25.899999618530273px_24px_rgba(109,109,109,0.03)] items-center'>
                        <div className="w-full text-zinc-900 text-xl sm:text-2xl md:text-3xl font-bold font-['Proxima_Nova'] leading-8 md:leading-10">Select a Date & Time</div>
                        <DateRangePicker />
                        <div className='w-full flex gap-3 sm:gap-4 md:gap-[18.7px] items-center'>
                            <svg width="18" height="18" className="sm:w-5 sm:h-5 md:w-[22px] md:h-[22px]" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
