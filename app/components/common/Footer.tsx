            ...
            <div className='flex flex-col gap-5'>
              ...
              <div className='flex flex-col gap-[5px]'>
                <div className='flex flex-col gap-2'>
                  ...
                  <Link href="mailto:example@gmail.com" className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7 cursor-pointer hover:text-white transition-colors">example@gmail.com</Link>
                </div>
                <div className='flex flex-col gap-2'>
                  <div className="justify-start text-white text-lg font-medium font-['Inter'] leading-loose">Phone:</div>
                  <Link href="tel:+8555588886666" className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7 cursor-pointer hover:text-white transition-colors">+85 555 8888 6666</Link>
                </div>
              </div>
            </div>
