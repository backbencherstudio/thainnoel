        ...
        <div className='flex flex-wrap flex-row justify-between gap-10 pb-8'>
          <div className='flex flex-col gap-6 w-fit'>
            <div className='flex flex-col gap-2'>
              <Image src={'/logos/PageBrandLogo.svg'} alt={''} height={200} width={200}  />
          ...
          <div className='flex flex-col gap-7.5 w-fit'>
            ...
            <div className='flex flex-col gap-4'>
              <div className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7">About Us</div>
              <div className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7">Use Cases</div>
              <div className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7">Our Services</div>
              <div className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7">Our Blogs</div>
              <div className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7">Contact Us</div>
            </div>
          </div>
          {/* Legals  */}
          <div className='flex flex-col gap-7.5 w-fit'>
            ...
            <div className='flex flex-col gap-4'>
              <div className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7">Privacy Policy</div>
              <div className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7">Terms of Services</div>
              <div className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7">Conditions</div>
              <div className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7">Cookies</div>
            </div>
          </div>
          {/* contact us  */}
            ...
            <div className='flex flex-col gap-5'>
              ...
              <div className='flex flex-col gap-[5px]'>
                <div className='flex flex-col gap-2'>
                  ...
                  <div className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7 cursor-pointer">example@gmail.com</div>
                </div>
                <div className='flex flex-col gap-2'>
                  <div className="justify-start text-white text-lg font-medium font-['Inter'] leading-loose">Phone:</div>
                  <div className="justify-start text-gray-200 text-base font-normal font-['Inter'] leading-7 cursor-pointer" >+85 555 8888 6666</div>
                </div>
              </div>
            </div>
