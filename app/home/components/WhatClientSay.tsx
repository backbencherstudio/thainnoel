...
const WhatClientSay = () => {
    return (
        <div className='flex flex-col gap-6 md:gap-8 lg:gap-12 py-12 md:py-16 lg:py-25'>
            <div className='flex flex-col lg:flex-row custom-Container justify-between items-start lg:items-end gap-4 md:gap-6 lg:gap-8'>
                    ...
                    {reviewCards.map((review, index) => (
                        <div key={index} className="max-w-[280px] sm:max-w-[320px] md:max-w-[458px] my-2 mx-1 sm:mx-2 md:mx-4 h-[400px] sm:h-[450px] md:h-[500px] w-full p-3 sm:p-4 md:p-[30px] bg-white outline-1 outline-offset-[-1px] outline-zinc-400 inline-flex flex-col justify-start items-start gap-3 sm:gap-4 md:gap-6 overflow-hidden">
                            <div className="w-full flex-1 flex flex-col justify-start items-start gap-3 sm:gap-4 md:gap-5">
                                <span className="px-2 py-1 bg-blue-600 text-center justify-start text-white text-xs sm:text-sm md:text-base font-semibold font-['Inter'] leading-6 md:leading-7">{review.tag}</span>
