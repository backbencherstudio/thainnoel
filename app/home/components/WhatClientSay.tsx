...
const WhatClientSay = () => {
    return (
        <div className='flex flex-col gap-6 sm:gap-8 md:gap-12 py-12 sm:py-16 md:py-25'>
            ...
            <div>
                <Marquee className=' ' autoFill speed={60} direction="left"  gradient gradientWidth={70} pauseOnHover>
                    {reviewCards.map((review, index) => (
                        <div key={index} className="max-w-[280px] sm:max-w-[320px] md:max-w-[458px] my-1 sm:my-2 mx-1 sm:mx-2 md:mx-4 h-[400px] sm:h-[450px] md:h-[500px] w-full p-3 sm:p-4 md:p-[30px] bg-white outline-1 outline-offset-[-1px] outline-zinc-400 inline-flex flex-col justify-start items-start gap-3 sm:gap-4 md:gap-6 overflow-hidden">
                            <div className="w-full flex-1 flex flex-col justify-start items-start gap-3 sm:gap-4 md:gap-5">
                                <span className="px-2 py-1 bg-blue-600 text-center justify-start text-white text-xs sm:text-sm md:text-base font-semibold font-['Inter'] leading-5 sm:leading-6 md:leading-7">{review.tag}</span>
                                <div className="self-stretch flex-1 justify-start text-black text-sm sm:text-lg md:text-2xl font-semibold font-['Inter'] leading-relaxed md:leading-loose">{review.review}</div>
                                <div className="w-full flex justify-start items-center gap-2 sm:gap-3 md:gap-4">
                                    ...
                                    <div className="flex flex-col justify-center items-start">
                                        <div className="text-center justify-start text-black text-xs sm:text-sm md:text-base font-semibold font-['Inter'] leading-5 sm:leading-6 md:leading-7">{review.profileName}</div>
                                        <div className="text-center justify-start text-neutral-600 text-xs sm:text-xs md:text-sm font-normal font-['Inter'] leading-normal">{review.companyPosition}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
