...
const ComprehensiveSolution = () => {
    return (
        <div className='flex flex-col gap-6 sm:gap-8 md:gap-12 custom-Container py-12 sm:py-16 md:py-25'>
                            ...
                            <div className='w-full flex flex-col gap-3 sm:gap-4 md:gap-6'>
                                ...
                                <div className='w-full flex flex-col gap-2 sm:gap-2.5 md:gap-3'>
                                    <div className='flex gap-1.5'>
                                        <Image src={'/icons/checkmark-square-01-solid-sharp 1.svg'} alt={''} width={200} height={200} className='w-4 sm:w-4 md:w-5 flex-shrink-0' />
