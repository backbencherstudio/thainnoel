...
const ComprehensiveSolution = () => {
    return (
        <div className='flex flex-col gap-6 md:gap-8 lg:gap-12 custom-Container py-12 md:py-16 lg:py-25'>
            <div className='flex flex-col lg:flex-row justify-between items-start lg:items-end gap-4 md:gap-6 lg:gap-8'>
            ...
            <div className='bg-[#F6F8FA] overflow-hidden p-3 md:p-4 lg:p-5 xl:p-10 flex flex-col lg:flex-row justify-between items-center gap-4 md:gap-6 lg:gap-8'>
                <Tabs defaultValue="founders" className="w-full lg:max-w-[498px] gap-3 md:gap-4">
                    <TabsList className='bg-white w-full lg:w-fit rounded-none gap-0 md:gap-3 py-3 md:py-4 lg:py-7 px-2 md:px-3 flex flex-col sm:flex-row'>
                        <TabsTrigger className="data-[state=active]:bg-blue-600 data-[state=active]:text-white text-gray-700 px-2 md:px-3 py-2 md:py-3 lg:py-4 rounded-none transition text-xs sm:text-sm md:text-base" value="founders">For Founders</TabsTrigger>
                        <TabsTrigger className="data-[state=active]:bg-blue-600 data-[state=active]:text-white text-gray-700 px-2 md:px-3 py-2 md:py-3 lg:py-4 rounded-none transition text-xs sm:text-sm md:text-base" value="operations">For Operations Leads</TabsTrigger>
                        <TabsTrigger className="data-[state=active]:bg-blue-600 data-[state=active]:text-white text-gray-700 px-2 md:px-3 py-2 md:py-3 lg:py-4 rounded-none transition text-xs sm:text-sm md:text-base" value="teams">For Teams</TabsTrigger>
                    </TabsList>
                    <TabsContent value="founders">
                        <div className='w-full lg:max-w-[498px] flex flex-col gap-4 md:gap-6 lg:gap-8'> 
                            <div className='w-full flex flex-col gap-3 md:gap-4 lg:gap-6'>
                                ...
                                <div className='w-full flex flex-col gap-1.5 md:gap-2 lg:gap-3'>
                                    <div className='flex gap-1.5'>
                                        <Image src={'/icons/checkmark-square-01-solid-sharp 1.svg'} alt={''} width={200} height={200} className='w-3.5 sm:w-4 md:w-5 flex-shrink-0' />
                    ...
                    <TabsContent value="operations">
                        <div className='w-full lg:max-w-[498px] flex flex-col gap-4 md:gap-6 lg:gap-8'>
                            <div className='w-full flex flex-col gap-3 md:gap-4 lg:gap-6'>
                                <div className='w-full flex flex-col gap-2 md:gap-3 lg:gap-4'>
                                    <div className="self-stretch justify-start text-neutral-800 text-xl sm:text-2xl md:text-3xl font-bold font-Inter leading-tight md:leading-10">For Operations Leads</div>
                                    <div className="self-stretch justify-start text-neutral-600 text-sm sm:text-base md:text-lg font-normal font-Inter capitalize leading-relaxed">Reliable, affordable solar installations for homes: cut bills, boost efficiency, and power sustainably.</div>
                                </div>
                                <div className='w-full flex flex-col gap-1.5 md:gap-2 lg:gap-3'>
                                    <div className='flex gap-1.5'>
                    ...
                    <TabsContent value="teams">
                        <div className='w-full lg:max-w-[498px] flex flex-col gap-4 md:gap-6 lg:gap-8'>
                            <div className='w-full flex flex-col gap-3 md:gap-4 lg:gap-6'>
                                <div className='w-full flex flex-col gap-2 md:gap-3 lg:gap-4'>
                                    <div className="self-stretch justify-start text-neutral-800 text-xl sm:text-2xl md:text-3xl font-bold font-Inter leading-tight md:leading-10">For Teams</div>
                                    <div className="self-stretch justify-start text-neutral-600 text-sm sm:text-base md:text-lg font-normal font-Inter capitalize leading-relaxed">Reliable, affordable solar installations for homes: cut bills, boost efficiency, and power sustainably.</div>
                                </div>
                                <div className='w-full flex flex-col gap-1.5 md:gap-2 lg:gap-3'>
                                    <div className='flex gap-1.5'>
                ...
                <Image src={'/ComprehensiveSolution.png'} width={2000} height={2000} alt={''} className='w-full max-w-[400px] sm:max-w-[500px] md:max-w-[574px] mt-4 md:mt-6 lg:mt-0' />
            </div>
        </div>
    )
}
