                ...
                <div className="relative w-full h-[300px] sm:h-[350px] md:h-[400px] lg:h-[504px] px-3 md:px-4 py-4 sm:py-6 md:py-8 group cursor-pointer overflow-hidden">
                    ...
                    <div className="relative z-20 flex flex-col justify-end items-start h-full gap-2.5">
                        ...
                        <div className=" absolute z-10 bottom-0 right-0 left-0 group-hover:opacity-0 opacity-100 transition-opacity duration-500 ease-in-out w-full p-2 sm:p-3 md:p-4 bg-white  flex justify-between items-center">
                            <div className="justify-start text-black text-base sm:text-lg md:text-2xl font-semibold font-['Poppins'] leading-tight md:leading-9">
                                Process Optimization
                            </div>
                            <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 p-1.5 sm:p-2 md:p-3 bg-blue-600 rounded-3xl flex justify-start items-center gap-2.5">
                                <div className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 relative overflow-hidden">
